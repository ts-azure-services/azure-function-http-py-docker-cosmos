...
new_url="https://albatross8888functionapp.azurewebsites.net/api/httpcosmos"
...
#echo 'using url: '$url
#
AZURE_FUNCTION_SECRET="26FA34B3-03EE-47BD-82B1-3222AAF3A3A9"

curl -X POST \
    -H "Content-Type: application/json" \
    -H "Auth-Token:"$AZURE_FUNCTION_SECRET \
